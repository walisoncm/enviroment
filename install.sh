...
# Installs Powerlevel10k suggested fonts
...
# Activates the powerlevel10k theme in the zsh configuration file
echo 'ZSH_THEME="powerlevel10k/powerlevel10k"' >> ~/.zshrc

# Activates the zsh-syntax-highlighting plugin in the zsh configuration file
echo 'plugins+=(zsh-syntax-highlighting)' >> ~/.zshrc

# Installs Neovim and fzf
